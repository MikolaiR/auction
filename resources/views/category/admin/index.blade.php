...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            @include('layouts.breadcrumb', ['admin' => true, 'pageTitle' => __('Category'), 'hasBack' => true, 'backTitle' => __('Dashboard'), 'backUrl' => route('admin.dashboard')])

             <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-between">
                            <h3 class="card-title mb-0">{{ __('All Category List') }}</h3>
                            <a href="{{ route('admin.category.create') }}" class="btn btn-primary float-right">{{ __('Add New Category') }}</a>
                        </div>
                                                                    ...
                                                                    <thead class="border-top">
                                                                        <tr>
                                                                            <th class="bg-transparent border-bottom-0"
                                                                                style="width: 5%;">{{ __('Category Name') }}</th>
