...
@include('layouts.breadcrumb', ['admin' => false, 'pageTitle' => __('Dashboard')])
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        <div class="header">
                                            <h5>{{ __('Total Auction') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{$metrics['total_ads']}}</h2>
                                            </div>
                                            <div class="icon">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.2s; animation-name: fadeInDown;">
                                        <div class="header">
                                            <h5>{{ __('Published Auction') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{$metrics['total_published_ads']}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50"
                                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.4s; animation-name: fadeInDown;">
                                        <div class="header">
                                            <h5>{{ __('Total Accepted Bids') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{$metrics['total_accepted_bids']}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="46" height="48" viewBox="0 0 46 48"
                                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.4s; animation-name: fadeInDown;">
                                        <div class="header">
                                            <h5>{{ __('Total Bid Amount') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{money($metrics['total_bid_amount'], true)}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50"
                                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        <div class="header">
                                            <h5>{{ __('Total Amount Paid') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{money($metrics['total_amount_paid'], true)}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50"
                                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.8s; animation-name: fadeInDown;">
                                        <div class="header">
                                            <h5>{{ __('Total Pending Payouts') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{money($metrics['total_pending_payout_amount'], true)}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50"
                                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.8s; animation-name: fadeInDown;">
                                        <div class="header">
                                            <h5>{{ __('Total Paid Payouts') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{money($metrics['total_paid_payout_amount'], true)}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50"
                                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.8s; animation-name: fadeInDown;">
                                        <div class="header">
                                            <h5>{{ __('Total Bids On Auctions') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{$metrics['total_bids_made_on_ads_owned_by_user']}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50"
                                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s"
                                        ...
                                        <div class="header">
                                            <h5>{{ __('Total Payout Method') }}</h5>
                                        </div>
                                        <div class="body">
                                            <div class="counter-item">
                                                <h2>{{$metrics['total_payout_methods']}}</h2>
                                            </div>
                                            <div class="icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50"
                                                    xmlns="http://www.w3.org/2000/svg">
