<form class="row bid-filter">
    <div class="col-sm-12 col-md-3">
        <div id="data-table_filter" class="dataTables_filter">
            <label>{{ __('Search for a pyt_tokens, names, etc') }}</label>
            <input type="search" name="search" class="form-control form-control" placeholder="{{ __('Search pyt_tokens, names, etc..') }}" aria-controls="data-table" value="{{ request()->search }}">
    ...
    <div class="col-sm-12 col-md-3">
        <div class="row mb-4">
            <div id="data-table_filter" class="dataTables_filter">
                <label>{{ __('Search payout methods') }}</label>
                <input type="search" name="payout_method" class="form-control form-control" placeholder="{{ __('Search payout method ids...') }}" aria-controls="data-table" value="{{ request()->payout_method }}">
