<form class="row bid-filter">
    <div class="col-sm-12 col-md-8">
        <div id="data-table_filter" class="dataTables_filter">
            <label>{{ __('Search for a post title, author, id:') }}</label>
            <input type="search" name="search" class="form-control form-control" placeholder="{{ __('Search for a post title, author, id...') }}" aria-controls="data-table" value="{{ request()->search }}">
