       ...
       <ul class="side-menu">
         ...
         <li class="slide">
          ...
          <li class="slide">
            <a  @class(['side-menu__item', 'has-link', 'active' => preg_match('/auctiontype.*/', $active)]) data-bs-toggle="slide" href="{{  route('admin.auctiontype.index')}}">
             <i class="side-menu__icon fa-regular fa-users"></i>
             <span class="side-menu__label">{{ __('Auction Type') }}</span>
          </a>
          </li>
          <li class="slide">
         ...
         <li @class(['slide', 'is-expanded' => preg_match('/ads.*/', $active)])>
           <a @class(['side-menu__item', 'has-link', 'active' => preg_match('/ads.*/', $active)]) data-bs-toggle="slide" href="javascript:void(0)"><i
               class="side-menu__icon fa-regular fa-cube"></i><span class="side-menu__label">{{ __('Auctions') }}</span><i
               ...
               <div class="panel-body tabs-menu-body p-0 border-0">
                 <div class="tab-content">
                   <div class="tab-pane active" id="side1">
                     <ul class="sidemenu-list">
                       <li><a href="{{ route('admin.ads.index') }}" @class(['slide-item', 'active' => $active === 'ads.all'])> {{ __('All Listings') }}</a></li>
                       <li><a href="{{ route('admin.ads.active') }}" @class(['slide-item', 'active' => $active === 'ads.active'])> {{ __('Active Listings') }}</a></li>
                       <li><a href="{{ route('admin.ads.upcoming') }}" @class(['slide-item', 'active' => $active === 'ads.upcoming'])> {{ __('Upcoming Listings') }}</a></li>
                       <li><a href="{{ route('admin.ads.pending') }}" @class(['slide-item', 'active' => $active === 'ads.pending'])> {{ __('Pending Listings') }}</a></li>
                       <li><a href="{{ route('admin.ads.expired') }}" @class(['slide-item', 'active' => $active === 'ads.expired'])> {{ __('Expired Listings') }}</a></li>
                       <li><a href="{{ route('admin.ads.rejected') }}" @class(['slide-item', 'active' => $active === 'ads.rejected'])> {{ __('Rejected Listings') }}</a></li>
                       <li><a href="{{ route('admin.ads.reported') }}" @class(['slide-item', 'active' => $active === 'ads.rejected'])> {{ __('Reported Listings') }}</a><span class="badge bg-green br-5 side-badge blink-text pb-1">{{ __('New') }}</span></li>
                     </ul>
                   </div>
                 </div>
               </div>
         ...
         <li class="slide">
          <a @class(['side-menu__item', 'has-link', 'active' => $active === 'bids']) data-bs-toggle="slide" href="{{ route('admin.bids.index') }}">
            ...
            <span class="side-menu__label">{{ __('Bids') }}</span>
           </a>
         </li>
         <li class="sub-category">
           <h3>{{ __('Payments') }}</h3>
         ...
         <li @class(['slide', 'is-expanded' => preg_match('/payments.*/', $active)])>
           <a @class(['side-menu__item', 'has-link', 'active' => preg_match('/payments.*/', $active)]) data-bs-toggle="slide" href="javascript:void(0)"><i
               class="side-menu__icon fa-light fa-credit-card"></i><span class="side-menu__label">{{ __('Payments') }}</span><i
               class="fa-light fa-chevron-right fa-2xs"></i>
           </a>
               ...
               <div class="panel-body tabs-menu-body p-0 border-0">
                 <div class="tab-content">
                   <div class="tab-pane active" id="side9">
                     <ul class="sidemenu-list">
                       <li><a href="{{ route('admin.payments.index') }}" @class(['slide-item', 'active' => $active === 'payments.all'])> {{ __('All Payments') }}</a></li>
                       <li><a href="{{ route('admin.payments.pending') }}" @class(['slide-item', 'active' => $active === 'payments.pending'])> {{ __('Pending Payments') }}</a></li>
                       <li><a href="{{ route('admin.payments.success') }}" @class(['slide-item', 'active' => $active === 'payments.successful'])> {{ __('Successful Payments') }}</a></li>
                       <li><a href="{{ route('admin.payments.failed') }}" @class(['slide-item', 'active' => $active === 'payments.failed'])> {{ __('Failed Payments') }}</a></li>
                     </ul>
                   </div>
                 </div>
               </div>
         ...
         <li @class(['slide', 'is-expanded' => preg_match('/payouts.*/', $active)])>
           <a @class(['side-menu__item', 'has-link', 'active' => preg_match('/payouts.*/', $active)]) data-bs-toggle="slide" href="javascript:void(0)"><i
               class="side-menu__icon fa-regular fa-money-check"></i><span class="side-menu__label">{{ __('Payouts') }}</span><i
               class="fa-light fa-chevron-right fa-2xs"></i>
           </a>
               ...
               <div class="panel-body tabs-menu-body p-0 border-0">
                 <div class="tab-content">
                   <div class="tab-pane active" id="side13">
                     <ul class="sidemenu-list">
                       <li><a href="{{ route('admin.payouts.index') }}" @class(['slide-item', 'active' => $active === 'payouts.all'])> {{ __('All Payouts') }}</a></li>
                       <li><a href="{{ route('admin.payouts.pending') }}" @class(['slide-item', 'active' => $active === 'payouts.pending'])> {{ __('Pending Payouts') }}</a></li>
                       <li><a href="{{ route('admin.payouts.success') }}" @class(['slide-item', 'active' => $active === 'payouts.successful'])> {{ __('Successful Payouts') }}</a></li>
                       <li><a href="{{ route('admin.payouts.failed') }}" @class(['slide-item', 'active' => $active === 'payouts.failed'])> {{ __('Failed Payouts') }}</a></li>
                     </ul>
                   </div>
                 </div>
               </div>
         ...
         <li class="slide">
          <a @class(['side-menu__item', 'has-link', 'active' => $active === 'payout-methods']) data-bs-toggle="slide" href="{{route('admin.payout-methods.index')}}">
           ...
           <span class="side-menu__label">{{ __('Methods') }}</span>
          </a>
         </li>
         <li class="sub-category">
           <h3>{{ __('General') }}</h3>
               ...
               <div class="panel-body tabs-menu-body p-0 border-0">
                 <div class="tab-content">
                   <div class="tab-pane active" id="side33">
                     <ul class="sidemenu-list">
                       <li><a href="{{ route('admin.blogs.index') }}" @class(['slide-item', 'active' => $active === 'blogs.all'])>{{ __('All Blogs') }}</a></li>
                       <li><a href="{{ route('admin.blogs.create') }}" @class(['slide-item', 'active' => $active === 'blogs.create'])> {{ __('Create Blog') }}</a></li>
                       <li><a href="{{ route('admin.comments.index') }}" @class(['slide-item', 'active' => $active === 'blogs.comments'])> {{ __('All Comments') }}</a></li>
                     </ul>
                   </div>
                 </div>
               </div>
         ...
         <li class="slide">
           <a @class(['side-menu__item', 'has-link', 'active' => preg_match('/support.*/', $active)]) data-bs-toggle="slide" href="javascript:void(0)"><i
               class="side-menu__icon fa-regular fa-messages"></i><span class="side-menu__label">{{ __('Support') }}</span><i
               class="fa-light fa-chevron-right fa-2xs"></i>
           </a>
           <ul class="slide-menu">
             <li class="panel sidetab-menu">
               <div class="panel-body tabs-menu-body p-0 border-0">
                 <div class="tab-content">
                   <div class="tab-pane active" id="side37">
                     <ul class="sidemenu-list">
                       <li><a href="{{ route('admin.support.index') }}" @class(['slide-item', 'active' => $active === 'support.all'])> {{ __('All Tickets') }}</a></li>
                       <li><a href="{{ route('admin.support.pending') }}" @class(['slide-item', 'active' => $active === 'support.pending'])> {{ __('Pending Tickets') }}</a></li>
                       <li><a href="{{ route('admin.support.resolved') }}" @class(['slide-item', 'active' => $active === 'support.resolved'])> {{ __('Resolved Tickets') }}</a></li>
                       <li><a href="{{ route('admin.support.create') }}" @class(['slide-item', 'active' => $active === 'support.create'])> {{ __('Create Ticket') }}</a></li>
                     </ul>
                   </div>
                 </div>
               </div>
    ...
    <div class="nav flex-column nav-pills gap-4 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s" style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.2s; animation-name: fadeInUp;">
       ...
       <a href="{{ route('user.listing-bids') }}" @class(['nav-link', 'nav-btn-style', 'mx-auto', 'mb-20', 'active' => $active === 'bidding'])>
          <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
             <path
                d="M19.7115 18.1422L18.729 5.7622C18.6678 4.96461 17.9932 4.3398 17.1933 4.3398H15.2527V4.25257C15.2527 1.90768 13.345 0 11.0002 0C8.65527 0 6.74758 1.90768 6.74758 4.25257V4.3398H4.80703C4.00708 4.3398 3.33251 4.96457 3.2715 5.76052L2.28872 18.1439C2.21266 19.1354 2.55663 20.1225 3.23235 20.852C3.90808 21.5815 4.86598 22 5.86041 22H16.1399C17.1342 22 18.0922 21.5816 18.768 20.852C19.4437 20.1224 19.7876 19.1354 19.7115 18.1422ZM8.03622 1.39648C9.80582 1.62851 10.5148 2.35468 10.7211 3.22695C10.764 3.41601 10.7855 3.73398 10.7855 4.24101V4.98437H8.33629H5.88707V4.20664C5.88707 3.34726 5.93004 3.08515 6.14488 2.66836C6.45426 2.0625 7.05582 1.57265 7.70465 1.39648C8.00113 1.31914 8.64137 1.31914 8.93785 1.39648ZM4.55504 7.13281V7.94922H5.22105H5.88707V7.13281V6.3164H8.33629H10.7855V7.13281V7.94922H11.4515H12.1175V7.13281V6.3164H13.0199C13.8964 6.3164 13.9222 6.3207 13.9222 6.40234C13.9222 6.44961 13.991 7.64414 14.0726 9.05351C14.1586 10.4586 14.2187 11.6187 14.2144 11.623C14.2058 11.6273 14.0425 11.7004 13.8449 11.7863C12.3539 12.4223 11.2796 13.5867 10.8113 15.0734C10.4804 16.1219 10.489 17.368 10.8285 18.382L10.9488 18.7387L7.28785 18.7258L3.63121 18.7129L3.39488 18.6184C2.91363 18.4207 2.45386 17.9609 2.27769 17.5012C2.22183 17.3594 2.17027 17.1144 2.16168 16.9297C2.14449 16.6633 2.64293 7.66562 2.73316 6.62578L2.75894 6.3164H3.65699H4.55504V7.13281ZM16.9429 12.8648C18.0515 13.1914 18.9324 13.9262 19.4308 14.9316C19.7273 15.5246 19.8519 16.0531 19.8519 16.7105C19.8476 18.3519 18.8379 19.8172 17.2996 20.4145C16.8312 20.5949 16.4144 20.6723 15.8773 20.6723C14.9234 20.6723 14.1414 20.3973 13.3765 19.7914C12.7707 19.3102 12.2507 18.5195 12.0273 17.7461C11.8984 17.2863 11.8683 16.4227 11.9629 15.9371C12.255 14.5105 13.3379 13.3117 14.7257 12.8906C15.2027 12.7445 15.4089 12.723 16.0062 12.7402C16.4488 12.7488 16.6422 12.7789 16.9429 12.8648Z">
             </path>
             <path
